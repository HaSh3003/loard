...
func sendSpoofedTalkDemo(chatJID types.JID, spoofedJID types.JID, toGender string, language string, spoofedFile string) {
	...
	msgmap["ar"]["generic"][1] = "عايز ايه تاني؟"
	msgmap["ar"]["generic"][2] = "❤️❤️❤️❤️❤️"
	msgmap["ar"]["generic"][3] = "For you, I am always available, my love..."
	msgmap["ar"]["generic"][4] = "Just call me and I'll come..."
	msgmap["ar"]["generic"][5] = "My deliciousness..."
	msgmap["ar"]["generic"][6] = "I loved this motel you chose just for the two of us..."
	msgmap["ar"]["boy"] = make(map[int]string)
	msgmap["ar"]["boy"][0] = "Last night was wonderful, come more often when my wife isn't here..."
	msgmap["ar"]["boy"][1] = "All yours!"
	msgmap["ar"]["girl"] = make(map[int]string)
	msgmap["ar"]["girl"][0] = "بتعرف تلعب شترنج"
	msgmap["ar"]["girl"][1] = "All yours!"
